    ...
    if (savedUser) {
      try {
        ...
        if (parsedUser.image_url) {
          setImagePreview(parsedUser.image_url);
        }
      } catch (error) {
...
const handleProfileImageUpload = async () => {
  ...
  const ProfileAvatar = ({
    ...
    return (
      <div
        className={`${size} relative flex shrink-0 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 font-bold text-white ${textSize}`}
      >
        {imagePreview ? (
          <img
            src={imagePreview}
          ...
          <div className="mb-8 rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
            ...
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  Update your CloudDrive profile picture
                </p>
            ...
            <div className="flex flex-col gap-6 sm:flex-row sm:items-center">
              ...
              <div className="flex justify-center sm:justify-start">
                ...
                <div className="h-28 w-28 overflow-hidden rounded-full border-4 border-indigo-100 bg-gradient-to-br from-indigo-500 to-purple-500 shadow-lg">
              ...
              <div className="flex-1">
                ...
                <label
                  ...
                  className="mb-3 inline-flex cursor-pointer rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-indigo-300 hover:bg-indigo-50 hover:text-indigo-600"
                >
                  📷 Choose Image
                </label>
                ...
                <div>
                  ...
                  <button
                    ...
                    className="rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 px-5 py-3 text-sm font-semibold text-white shadow-md transition hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-50"
                  >
